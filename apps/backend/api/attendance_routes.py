...
def checkin_face():
    ...
    try:
        ...
        result = service.recognize_face(temp_filepath, enrolled_embeddings, threshold)
...
def get_session_stats(buoi_hoc_id):
    ...
    try:
        ...
        stats = {
            ...
            'recognized_count': sum(1 for a in attendance if a.CheckInMethod == 'DEEPFACE')
        }
