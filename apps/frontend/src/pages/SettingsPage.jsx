  ...
  return (
    <section className="rounded-panel border border-slate-200 bg-white p-5 shadow-panel sm:p-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Tùy chỉnh hệ thống</span>
          <h2 className="mt-1 text-2xl font-bold tracking-tight text-slate-900">Thiết lập</h2>
        </div>
      </div>

      <h3 className="mt-5 text-base font-semibold text-slate-800">Cài đặt hệ thống</h3>
      ...
      <form className="mt-4">
        <fieldset className="grid gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
          <legend className="px-1 text-sm font-semibold text-slate-700">Tham số nhận diện</legend>
